...
describe("ApiRegistry", () => {
    describe("Singleton Instance", () => {
        it("should provide a singleton instance with pre-registered providers", () => {
            const providers = apiRegistry.getAllProviders();
            ...
            expect(providerNames).toContain("Nutritionix");
        });
    ...
    describe("Provider Registration", function () {
        ...
        it("should register and retrieve providers correctly", function () {
            ...
            expect(testRegistry.getAllProviders().length).toBe(2);
        ...
        it("should replace provider with same name", function () {
            ...
            expect(testRegistry.getAllProviders().length).toBe(1);

            // Should have the last registered provider
