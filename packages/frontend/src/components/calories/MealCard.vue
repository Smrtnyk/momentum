<template>
    <v-card class="meal-card" elevation="1">
        <v-card-item>
            ...
            <v-card-subtitle>{{ meal.totalCalories }} calories</v-card-subtitle>
            ...
            >
                <template #prepend>
                    <v-avatar size="32" class="mr-2">
                        ...
                        <template v-else>
                            <v-icon v-if="isCustomFood(food)" color="white">mdi-food-apple</v-icon>
...
function isCustomFood(food: FoodItem): boolean {
    return "isCustom" in food && (food as any).isCustom === true;
}
